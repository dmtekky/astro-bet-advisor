...
const EnhancedDashboard: React.FC = () => {
  ...
  const { data: ephemeris, isLoading: isLoadingEphemeris } =
    useCurrentEphemeris();
  const { data: weights, isLoading: isLoadingWeights } =
    useFormulaWeights(sport);
        ...
        const transformedGames: Game[] = gamesData.map((game: any) => {
          ...
          return {
            ...
            league:
              game.league ||
              (game.sport_key
                ? game.sport_key.toUpperCase()
                : sportKey.includes("_")
                  ? sportKey.split("_")[1].toUpperCase()
  ...
  const getTeamLogo = (teamId: string) => {
    ...
    return (
      team?.logo ||
      `https://via.placeholder.com/40?text=${teamId.substring(0, 2).toUpperCase()}`
    );
  };
  ...
  console.log(
    "DASHBOARD GAMES DATA:",
    games.map((g, idx) => ({
      idx,
      id: g?.id,
      home_team:
        typeof g.home_team === "object" ? g.home_team.name : g.home_team,
      away_team:
        typeof g.away_team === "object" ? g.away_team.name : g.away_team,
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <header className="text-center">
          ...
          <p className="text-gray-600">
            Your astrological edge in sports betting
          </p>
        </header>
                  ...
                  games
                    ...
                    .map((game, idx) => {
                      ...
                      console.log(`RENDERING GAMECARD idx=${idx}`, {
                        id: gameId,
                        home_team:
                          typeof game.home_team === "object"
                            ? game.home_team.name
                            : game.home_team,
                        away_team:
                          typeof game.away_team === "object"
                            ? game.away_team.name
                            : game.away_team,
                        ...
                        home_team:
                          game.home_team && typeof game.home_team === "object"
                            ? {
                                ...
                                wins:
                                  typeof game.home_team.wins === "number"
                                    ? game.home_team.wins
                                    : 0,
                                losses:
                                  typeof game.home_team.losses === "number"
                                    ? game.home_team.losses
                                    : 0,
                                abbreviation:
                            ...
                            : {
                                ...
                                losses: 0,
                                abbreviation:
                                  game.home_team_abbreviation || "HOM",
                              },
                        away_team:
                          game.away_team && typeof game.away_team === "object"
                            ? {
                                id:
                                  game.away_team.id ||
                                  game.away_team_id ||
                                ...
                                wins:
                                  typeof game.away_team.wins === "number"
                                    ? game.away_team.wins
                                    : 0,
                                losses:
                                  typeof game.away_team.losses === "number"
                                    ? game.away_team.losses
                                    : 0,
                                abbreviation:
                            ...
                            : {
                                ...
                                losses: 0,
                                abbreviation:
                                  game.away_team_abbreviation || "AWY",
                              },
                        // Add required astro properties with default values
                        astroEdge:
                          typeof game.astroEdge === "number"
                            ? game.astroEdge
                            : 0,
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <img
                            src={
                              team.logo ||
                              `https://via.placeholder.com/40?text=${team.name.substring(0, 2).toUpperCase()}`
                            }
                            alt={team.name}
