  ...
  return (
    <header className="fixed w-full z-50 shadow-lg">
      ...
      <div className="container mx-auto px-2 sm:px-4 py-2 sm:py-4">
                ...
                <div className="py-1">
                  {leagues.map((league) => (
                    ...
                    >
                      ...
                      {league.name}
                      {league.comingSoon && <span className="ml-2 text-xs text-yellow-500">(Coming Soon)</span>}
                    </Link>
                  ))}
                </div>
              </div>
        ...
        <div className={`fixed inset-y-0 right-0 w-full sm:w-96 bg-white z-50 transform transition-transform duration-300 ease-in-out shadow-2xl md:hidden ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          ...
          {/* Scrollable content */}
          <div className={`overflow-y-auto pb-6 ${user ? 'h-[calc(100%-64px)]' : 'h-[calc(100%-120px)]'}`}>
            {/* Main Navigation */}
            <div className="p-2">
            ...
            {user && (
              <div className="p-2 border-t border-gray-100">
                ...
                >
                  ...
                  <svg className="ml-auto h-5 w-5 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
