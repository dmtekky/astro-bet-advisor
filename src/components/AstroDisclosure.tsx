      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <span className="font-medium text-slate-100">
            {prediction.predicted_winner || prediction.prediction || 'No clear prediction'}
          </span>
        </div>
        ...
        {(moonPhase || prediction.moonPhase) && (
          <div className="flex items-center justify-between">
            ...
            <span className="text-slate-300">{moonPhase || prediction.moonPhase}</span>
          </div>
        )}
        ...
        {(sunSign || prediction.sunSign) && (
          <div className="flex items-center justify-between">
            ...
            <span className="text-slate-300">{sunSign || prediction.sunSign}</span>
          </div>
        )}
        ...
        {mercuryRetrograde !== undefined && (
          <div className="flex items-center justify-between">
            ...
            <span className={mercuryRetrograde ? 'text-amber-400' : 'text-slate-300'}>
        ...
        {planetaryAspects && planetaryAspects.length > 0 && (
          <div className="mt-3">
            <h4 className="text-sm font-medium text-slate-300 mb-1">Key Planetary Aspects:</h4>
